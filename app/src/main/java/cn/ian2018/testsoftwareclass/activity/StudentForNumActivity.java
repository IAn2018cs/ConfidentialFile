...
public class StudentForNumActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    // 加载图片
                    Glide.with(StudentForNumActivity.this)
    ...
    private boolean familyIsOk;
    private boolean studentInfoIsOk;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_for_num);
